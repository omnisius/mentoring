...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mentoringstorefront/electronics/en",
						"https://electronics.local:9002/mentoringstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mentoringstorefront/electronics/en",
						"https://electronics.local:9002/mentoringstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mentoringstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mentoringstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mentoringstorefront/electronics/en",
						"https://electronics.local:9002/mentoringstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mentoringstorefront",
						"https://electronics.local:9002/mentoringstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mentoringstorefront",
						"https://electronics.local:9002/mentoringstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mentoringstorefront/electronics/en",
						"https://electronics.local:9002/mentoringstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
