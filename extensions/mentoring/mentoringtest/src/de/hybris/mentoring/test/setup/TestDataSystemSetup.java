 ...
 *
 */
package de.hybris.mentoring.test.setup;
...
import de.hybris.mentoring.test.constants.MentoringTestConstants;
import de.hybris.mentoring.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MentoringTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mentoringtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mentoringtest/import/reviews.impex");
			...
			importImpexFile(context, "/mentoringtest/import/cstickets.impex");
		}
	}
}
