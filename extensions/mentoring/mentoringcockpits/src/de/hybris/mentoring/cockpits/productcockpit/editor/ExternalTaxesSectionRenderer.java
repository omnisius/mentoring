 ...
 *
 */
package de.hybris.mentoring.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("mentoringcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("mentoringcockpits.product.externalTaxes"));
