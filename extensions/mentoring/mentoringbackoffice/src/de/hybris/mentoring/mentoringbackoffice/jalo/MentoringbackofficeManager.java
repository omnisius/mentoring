 ...
 */
package de.hybris.mentoring.mentoringbackoffice.jalo;
...
import de.hybris.mentoring.mentoringbackoffice.constants.MentoringbackofficeConstants;
 ...
 */
public class MentoringbackofficeManager extends GeneratedMentoringbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MentoringbackofficeManager.class.getName());
	 ...
	 */
	public static MentoringbackofficeManager getInstance()
	{
		return (MentoringbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MentoringbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MentoringbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MentoringbackofficeManager called.");
		}
	}
