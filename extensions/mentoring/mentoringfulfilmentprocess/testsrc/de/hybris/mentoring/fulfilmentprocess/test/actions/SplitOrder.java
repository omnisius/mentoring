 ...
 *
 */
package de.hybris.mentoring.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MentoringFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MentoringFulfilmentProcessConstants.PARENT_PROCESS);
