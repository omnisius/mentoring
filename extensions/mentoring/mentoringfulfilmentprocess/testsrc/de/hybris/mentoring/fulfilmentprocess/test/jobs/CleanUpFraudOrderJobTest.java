 ...
 *
 */
package de.hybris.mentoring.fulfilmentprocess.test.jobs;
...
import de.hybris.mentoring.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MentoringFulfilmentProcessConstants.ORDER_PROCESS_NAME;
